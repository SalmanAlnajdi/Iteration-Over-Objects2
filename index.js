const students = [
  ...
  **********/
  ...
  function getCourse(student, courseIndex) {
    // Your code here
    let studentCourse = student.courses[courseIndex]
  ...
  function countCourses(student) {
    ...
    let coursesNum = coursesArray.reduce((total ,co)=>total+=1,0)
    return coursesNum
  }
  ...
  function getStudentsByCourse(course, students) {
    ...
    const getStudent = students.filter(student => student.courses.includes(course));
